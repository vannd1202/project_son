/*
Day 7
Làm bài tập day 6, trình bày theo hướng đối tượng
 */
...
public class Products1 {
    ...
    List <Products1> products = new ArrayList<>();
    Scanner scanner = new Scanner(System.in);
    public static void main(String[] args) {
        Products1 main = new Products1();
        boolean exist = true;
        do {
            main.menuManage();
    ...
    public void searchProduct(){
        ...
        String name = scanner.nextLine();
        for (Products1 product : products) {
